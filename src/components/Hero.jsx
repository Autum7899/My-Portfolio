...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col items-center justify-center text-center relative overflow-hidden px-4 sm:px-6 lg:px-8"
    >
      <motion.div
      ...
      >
        ...
        >
          ...
          <motion.span
            ...
            whileHover={{
              textShadow:
                "0 0 12px rgba(59, 130, 246, 0.8), 0 0 24px rgba(147, 51, 234, 0.4)",
            }}
          >
            Download CV
          </motion.span>
