    ...
    <AnimatedSection id="skills">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="absolute inset-0 -m-4 rounded-2xl bg-gradient-to-r from-primary/10 via-white/10 to-primary/10 dark:from-primary/20 dark:via-black/20 dark:to-primary/20 backdrop-blur-md border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.08)]" />
        </motion.div>
          ...
          {skillCategories.map((category, categoryIndex) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 -m-3 bg-card/20 dark:bg-card/10 rounded-xl backdrop-blur-sm" />
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                {category.skills.map((skill, skillIndex) => (
                  <motion.div
                    key={skill.name}
                    className={`group relative flex flex-col items-center justify-center gap-4 p-6 rounded-2xl bg-card/30 dark:bg-card/10 backdrop-blur-sm border border-white/10 transition-all duration-300 hover:shadow-lg ${getLevelBackground(skill.level)}`}
                    initial={{ opacity: 0 }}
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <div className="p-4 rounded-xl bg-white/10 dark:bg-black/20 backdrop-blur-sm">
                        <img
                          src={skill.logo}
                          alt={`${skill.name} logo`}
