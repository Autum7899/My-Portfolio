...
const ProjectCard = memo(
  ({ project, index, viewMode, hoveredProject, setHoveredProject }) => {
    ...
    return (
      <motion.div
        ...
        className={`group relative ${
          viewMode === "list"
            ? "flex flex-col md:flex-row gap-6 p-6 bg-card/30 dark:bg-card/10 backdrop-blur-sm border border-white/10 shadow-xl hover:shadow-2xl hover:bg-card/40 dark:hover:bg-card/20 rounded-2xl"
            : "bg-card/30 dark:bg-card/10 backdrop-blur-sm border border-white/10 shadow-xl hover:shadow-2xl hover:bg-card/40 dark:hover:bg-card/20 rounded-2xl overflow-hidden transition-all duration-300"
        }`}
        whileHover={{
      ...
      >
        ...
        >
          ...
          >
            <motion.a
              href={project.demo}
              className="w-10 h-10 bg-black/20 dark:bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm"
          ...
          {index < 2 && (
            <motion.div
              className="absolute top-4 left-4 bg-black/20 dark:bg-white/20 px-3 py-1 rounded-full text-xs font-semibold text-primary-foreground flex items-center gap-1 backdrop-blur-sm"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{
                delay: 0.3 + index * 0.1,
  ...
  const categories = useMemo(
    () => [
      ...
      },
      {
        ...
        count: projects.filter((p) =>
          p.tags.some((tag) =>
            ["MySQL", "SQL Server", "MongoDB", "PostgreSQL"].includes(tag),
          ),
        ).length,
      },
    ],
              ...
              case "fullstack":
                return (
                  [
                    ...
                    "MongoDB",
                    "MySQL",
                  ].includes(tag) && project.tags.length > 3
                );
              case "database":
                return [
                  "MySQL",
        ...
        >
          ...
          >
            <motion.p className="text-xl text-muted-foreground mb-8 max-w-4xl mx-auto leading-relaxed">
              Explore my collection of projects that demonstrate my skills in
              full-stack development, problem-solving, and innovative thinking.
              Each project tells a story of learning and growth.
            </motion.p>
            <motion.div
          ...
          <motion.div className="text-center mt-16" variants={itemVariants}>
            <div className="bg-card/30 dark:bg-card/10 backdrop-blur-md border border-white/10 p-8 rounded-2xl max-w-2xl mx-auto">
