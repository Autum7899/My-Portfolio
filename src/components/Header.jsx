...
const NavLink = React.memo(({ link, isActive }) => {
  ...
  return (
    ...
    >
      <Icon
        size={16}
        className={`relative z-10 ${isActive ? "text-primary" : "group-hover:text-primary"}`}
      />
      <span
...
const MobileNavLink = React.memo(({ link, isActive, onClose }) => {
  ...
  return (
    ...
    >
      ...
      />
      <span
        className={`relative z-10 text-lg font-medium ${isActive ? "text-primary" : ""}`}
      >
        {link.name}
      </span>
    </a>
    ...
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-30 transition-all duration-500 ${
          isScrolled
            ? "bg-white/60 dark:bg-black/60 backdrop-blur-md shadow-md border-b border-primary/20"
            : "bg-transparent"
        }`}
      >
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <button
                ...
                className="group relative flex items-center justify-center p-3 rounded-xl bg-card/30 dark:bg-card/10 hover:bg-card/50 backdrop-blur-sm transition-all duration-300"
                title={
              ...
              <button
                ...
                className="lg:hidden p-3 rounded-xl bg-card/30 dark:bg-card/10 hover:bg-card/50 backdrop-blur-sm transition-all duration-300"
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className="fixed top-0 bottom-0 right-0 w-4/5 max-w-sm bg-white/98 dark:bg-gray-900/98 shadow-2xl z-50 lg:hidden border-l border-gray-200/60 dark:border-gray-700/60 backdrop-blur-md"
            >
              <div className="flex flex-col h-full p-6">
                ...
                <div className="flex justify-between items-center mb-8 pb-4 border-b border-gray-200/50 dark:border-gray-700/50">
                  ...
                  <motion.button
                    onClick={() => setIsMenuOpen(false)}
                    className="p-3 rounded-xl bg-card/30 dark:bg-card/10 hover:bg-card/50 backdrop-blur-sm transition-all duration-300 hover:scale-105 active:scale-95"
                ...
                <div className="mb-6">
                  <button
                    ...
                    className="group relative flex items-center space-x-3 px-5 py-4 rounded-xl bg-card/30 dark:bg-card/10 hover:bg-card/50 backdrop-blur-sm transition-all duration-300 text-lg font-medium w-full overflow-hidden"
                  >
