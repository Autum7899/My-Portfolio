...
import portfolioProjectImage from "../assets/Portfolio.png";
import smartLockProjectImage from "../assets/DuyMinh.png";
...
export const projects = [
  {
    ...
    description:
      "Created an engaging portfolio with smooth UI animations, a dark/light theme, and a Netlify-powered contact form storing inquiries in PostgreSQL. Optimized for fast performance across devices.",
    ...
    demo: "https://autumportfolio.netlify.app",
    repo: "https://github.com/Autum7899/My-Portfolio",
  },
  {
    title: "DM-SmartLock E-commerce Platform",
    description:
      "Built a scalable e-commerce platform with a RESTful API, Prisma-backed PostgreSQL database, and secure auth using NextAuth.js with JWT and RBAC.",
    image: smartLockProjectImage,
    tags: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
